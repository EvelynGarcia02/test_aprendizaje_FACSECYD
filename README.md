...
Abre `dashboard/index.html` con doble clic en el explorador de archivos. No necesita servidor ni instalación: los datos están embebidos en `js/data.js`, así que funciona directo desde el disco.
